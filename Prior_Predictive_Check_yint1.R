...
out <- filterout_priors(low_mu0 = 10,
                        high_mu0 = 40,
                        low_tau0 = 5,
                        high_tau0 = 10, 
                        y_int = y_int,
...
plot_2 <- xyplot(predict(fit_model, data_order) ~ data_order$x, col = 'black', type = 'l', xlim = c(14,36), ylim = c(4,10), 
...
plot(x = border_values_edge_df$x, y = predict(fit_model, border_values_edge_df), col = 'black',  xlim = c(12,36), ylim = c(5,10), xlab = 'mu0', ylab = 'tau0')
par(new = TRUE)
plot(border_values_edge_df$x, border_values_edge_df$y, xlim = c(12,36), ylim = c(5,10), xlab = 'mu0', ylab = 'tau0')
